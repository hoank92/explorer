                  ...
                  <b-col>
                    <div class="d-flex justify-content-between">
                      ...
                      <div class="text-right">
                        <h4 class="my-0">{{ formatBalance(acc.addr) }}{{ currency }}
                        </h4>
                      ...
                      <app-collapse-item title="Assets">
                        ...
                        >
                          ...
                          >
                            ...
                            <span class="font-small-2 text-muted text-nowrap">{{ formatCurrency(b.amount, b.denom) }}{{ currency }}</span>
                          </div>
                          <div class="d-flex flex-column text-right">
                            <span class="font-weight-bold mb-0">{{ formatPrice(b.denom) }}{{ currency }}</span>
                            <small
